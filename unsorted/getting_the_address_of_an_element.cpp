//
//
// Sarda, Suyog. LLVM Essentials: Become familiar with the LLVM infrastructure and start
// using LLVM libraries to design a compiler (p. 39). Packt Publishing. Kindle Edition.
//
